...
**Screenshots & Photos**
If applicable, add AxeOS screenshots and/or photos of your BITFORGE to help explain your problem.

**Hardware (please complete the following information):**
 - BITFORGE HW version: [e.g.Nano, etc]
 - BITFORGE HW vendor: [Where you purchased the BITFORGE, or self-built]

...
static const char * TAG = "i2c_bitforge";
 ...
 */
esp_err_t i2c_bitforge_init(void)
{
 ...
 */
esp_err_t i2c_bitforge_add_device(uint8_t device_address, i2c_master_dev_handle_t * dev_handle, const char *device_tag)
{
    ...
    ESP_LOGI(TAG, "Try to add device");
...
esp_err_t i2c_bitforge_get_master_bus_handle(i2c_master_bus_handle_t * dev_handle)
{
 ...
 */
esp_err_t i2c_bitforge_register_read(i2c_master_dev_handle_t dev_handle, uint8_t reg_addr, uint8_t * read_buf, size_t len)
{
 ...
 * @return esp_err_t 
 */
esp_err_t i2c_bitforge_register_write_addr(i2c_master_dev_handle_t dev_handle, uint8_t reg_addr)
{
 ...
 */
esp_err_t i2c_bitforge_register_write_byte(i2c_master_dev_handle_t dev_handle, uint8_t reg_addr, uint8_t data)
{
 ...
 */
esp_err_t i2c_bitforge_register_write_bytes(i2c_master_dev_handle_t dev_handle, uint8_t * data, uint8_t len)
{
 ...
 * @param data The data to write
 */
esp_err_t i2c_bitforge_register_write_word(i2c_master_dev_handle_t dev_handle, uint8_t reg_addr, uint16_t data)
{

...
```diff
-set(TEST_COMPONENTS "bm1366 stratum" CACHE STRING "List of components to test")
+set(TEST_COMPONENTS "bm1366 stratum foo" CACHE STRING "List of components to test")
```
